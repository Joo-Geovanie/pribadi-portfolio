  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:description', content: 'A full-stack dev from Indonesia // crafting clean interfaces, smooth 3D visuals, and solid backend systems.' },
        ...
        { name: 'twitter:description', content: 'A full-stack dev from Indonesia // crafting clean interfaces, smooth 3D visuals, and solid backend systems.' }
      ],
      link: [
