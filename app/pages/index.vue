...
<template>
  <div class="relative text-white min-h-[100dvh] scanlines overflow-x-hidden">
    ...
    <main class="relative z-20 max-w-7xl mx-auto px-4 sm:px-8 md:px-16 pt-16 sm:pt-20">
      ...
      <!-- ==================== SECTION 5: CONTACT ==================== -->
      <section class="py-16 sm:py-24 reveal-section min-h-[100dvh] flex flex-col justify-center" id="contact">
        <div class="max-w-xl">
          ...
          <p class="text-gray-300 text-xs sm:text-sm mb-8 leading-relaxed font-mono">
            Got an idea, a project, or just want to connect? Drop a message below!
          </p>

          <form @submit.prevent="sendPing" class="flex flex-col gap-5 bg-abyss-950/85 p-5 sm:p-8 border border-sonar-blue/30 rounded-lg backdrop-blur-md shadow-2xl">
            <div class="flex flex-col gap-1.5">
              <label class="text-[9px] text-gray-400 tracking-wider font-bold font-mono">YOUR NAME</label>
              <input
                v-model="cName"
                type="text"
                class="bg-black/60 border border-sonar-blue/25 p-3 sm:p-3.5 text-xs focus:border-sonar-blue focus:outline-none rounded text-white font-mono transition-colors pointer-events-auto"
            ...
            <div class="flex flex-col gap-1.5">
              <label class="text-[9px] text-gray-400 tracking-wider font-bold font-mono">YOUR MESSAGE</label>
              <textarea
                v-model="cMessage"
                class="bg-black/60 border border-sonar-blue/25 p-3 sm:p-3.5 text-xs focus:border-sonar-blue focus:outline-none rounded h-28 sm:h-32 text-white font-mono resize-none transition-colors pointer-events-auto"
                placeholder="Tell me about your project or what you'd like to build..."
              ></textarea>
            </div>

            <button
              type="submit"
              class="bg-sonar-orange hover:bg-sonar-orange/80 text-black font-bold p-3.5 text-xs uppercase tracking-[0.2em] rounded transition-all pointer-events-auto shadow-lg font-mono"
            >
              // SEND MESSAGE
            </button>
